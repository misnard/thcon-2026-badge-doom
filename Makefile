...
DOOM_DEFINES := -DNORMALUNIX -DMAXPLAYERS=1 -DDISABLE_NETWORK -DE1M1ONLY=1 -DCONST_DOOM_TABLES -DFIXED_HEAP=143360 -DSET_MEMORY_DEBUG=0 -Dalloca=__builtin_alloca
